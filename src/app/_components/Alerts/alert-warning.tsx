...
export function AlertWarning({ title, message, type }: IAlertProps) {
    switch (type) {
        case 'bordered':
            return (
        ...
        case 'borderedWithAccent':
            return (
                <div id="alert-bordered" className="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-300 dark:bg-gray-800 dark:border-yellow-800" role="alert">
