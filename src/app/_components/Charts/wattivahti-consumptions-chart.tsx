...
interface WattiVahtiConsumptionChartProps {
    wattivahtiResponse?: IWattiVahtiConsumptionResponse
    startDate: Dayjs
    endDate: Dayjs
    isLoading?: boolean
    style?: CSSProperties
...
export default function WattiVahtiConsumptionsChart({ wattivahtiResponse, startDate, endDate, isLoading, style }: WattiVahtiConsumptionChartProps) {
    if (isLoading) {
    ...
    const data = wattivahtiResponse.consumptions;
...
const mapper = ({ data, timePeriod }: { data: IWattiVahtiConsumption[], timePeriod: TimePeriod }) => {
