...
interface IProductionDescriptionSkeletonProps {
    isPulsing?: boolean;
}

const ProductionDescriptionSkeleton = ({ isPulsing = true }: IProductionDescriptionSkeletonProps) => {
    ...
    return (
        <Descriptions size={'small'} title="" layout="vertical" bordered>
            ...
            {getDescriptionItem("Perusmaksut ja tuoton arvo")}
        </Descriptions>
    );
};

export default ProductionDescriptionSkeleton;