  ...
  switch (data.type) {
    case "NewSpotPriceUpdate": {
      ...
      const str = [
        ...
        `Yön hinta: ${Number(data.offPeak1).toLocaleString("fi-FI", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        })} c/kWh`,
        `Päivän hinta: ${Number(data.peak).toLocaleString("fi-FI", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        })} c/kWh`,
        `Illan hinta: ${Number(data.offPeak2).toLocaleString("fi-FI", {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        })} c/kWh`,
      ].join('\n');
